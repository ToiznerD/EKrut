...
/**
 * UserManager is a class that manages the connected clients on server. It is a
 * static class with no constructor (created when server is up) It saves the
 * connections with HashMap: key-clientID, value-socket(ConnectionToClient)
 */
public class UserManager {
	 ...
	 * updates it in mysql the "isLogged" column to 0.
	 * 
	 * @param id: client ID
	 */
	...
	/**
	 * removeByClient public static method for removing from map with a value
	 * attribute(socket) if exist
	 * 
	...
	/**
	 * isConnected public static method for checking if a client is connected. It
	 * uses "SELECT" action for get "isLogged" value for the client ID
	 * 
	 * @param id: client ID
